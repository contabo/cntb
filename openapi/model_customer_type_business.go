...
// CustomerTypeBusiness struct for CustomerTypeBusiness
type CustomerTypeBusiness struct {
	// Company name
...
// GetVatId returns the VatId field value
...
// GetVatIdOk returns a tuple with the VatId field value
// and a boolean to check if the value has been set.
...
// SetVatId sets field value
func (o *CustomerTypeBusiness) SetVatId(v string) {
	o.VatId = v
}

func (o CustomerTypeBusiness) MarshalJSON() ([]byte, error) {
...
type NullableCustomerTypeBusiness struct {
	value *CustomerTypeBusiness
	isSet bool
}

func (v NullableCustomerTypeBusiness) Get() *CustomerTypeBusiness {
	return v.value
}

func (v *NullableCustomerTypeBusiness) Set(val *CustomerTypeBusiness) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerTypeBusiness) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerTypeBusiness) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerTypeBusiness(val *CustomerTypeBusiness) *NullableCustomerTypeBusiness {
	return &NullableCustomerTypeBusiness{value: val, isSet: true}
}

func (v NullableCustomerTypeBusiness) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerTypeBusiness) UnmarshalJSON(src []byte) error {
	v.isSet = true
