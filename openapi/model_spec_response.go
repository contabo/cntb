...
func (o SpecResponse) MarshalJSON() ([]byte, error) {
...
type NullableSpecResponse struct {
	value *SpecResponse
	isSet bool
}

func (v NullableSpecResponse) Get() *SpecResponse {
	return v.value
}

func (v *NullableSpecResponse) Set(val *SpecResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSpecResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSpecResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSpecResponse(val *SpecResponse) *NullableSpecResponse {
	return &NullableSpecResponse{value: val, isSet: true}
}

func (v NullableSpecResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSpecResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
