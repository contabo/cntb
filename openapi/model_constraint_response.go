...
// ConstraintResponse struct for ConstraintResponse
type ConstraintResponse struct {
	// Type of AddOn the include and exclude are meant for.
	Type string `json:"type"`
	// Array of AddOn keys to include of specific type.
	Include []AddonIdentifierResponse `json:"include"`
	// Array of AddOn identifiers to exclude of specific type.
	Exclude []AddonIdentifierResponse `json:"exclude"`
}
...
func (o *ConstraintResponse) GetInclude() []AddonIdentifierResponse {
	if o == nil {
		var ret []AddonIdentifierResponse
		return ret
	}
...
func (o ConstraintResponse) MarshalJSON() ([]byte, error) {
...
type NullableConstraintResponse struct {
	value *ConstraintResponse
	isSet bool
}

func (v NullableConstraintResponse) Get() *ConstraintResponse {
	return v.value
}

func (v *NullableConstraintResponse) Set(val *ConstraintResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableConstraintResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableConstraintResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConstraintResponse(val *ConstraintResponse) *NullableConstraintResponse {
	return &NullableConstraintResponse{value: val, isSet: true}
}

func (v NullableConstraintResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConstraintResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
