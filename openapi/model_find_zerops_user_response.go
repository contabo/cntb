...
// FindZeropsUserResponse struct for FindZeropsUserResponse
type FindZeropsUserResponse struct {
	Data []ZeropsUserResponse `json:"data"`
}
...
func (o FindZeropsUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindZeropsUserResponse struct {
	value *FindZeropsUserResponse
	isSet bool
}

func (v NullableFindZeropsUserResponse) Get() *FindZeropsUserResponse {
	return v.value
}

func (v *NullableFindZeropsUserResponse) Set(val *FindZeropsUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindZeropsUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindZeropsUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindZeropsUserResponse(val *FindZeropsUserResponse) *NullableFindZeropsUserResponse {
	return &NullableFindZeropsUserResponse{value: val, isSet: true}
}

func (v NullableFindZeropsUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindZeropsUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
