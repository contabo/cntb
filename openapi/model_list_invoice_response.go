...
// ListInvoiceResponse struct for ListInvoiceResponse
...
func (o ListInvoiceResponse) MarshalJSON() ([]byte, error) {
...
type NullableListInvoiceResponse struct {
	value *ListInvoiceResponse
	isSet bool
}

func (v NullableListInvoiceResponse) Get() *ListInvoiceResponse {
	return v.value
}

func (v *NullableListInvoiceResponse) Set(val *ListInvoiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListInvoiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListInvoiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInvoiceResponse(val *ListInvoiceResponse) *NullableListInvoiceResponse {
	return &NullableListInvoiceResponse{value: val, isSet: true}
}

func (v NullableListInvoiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInvoiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
