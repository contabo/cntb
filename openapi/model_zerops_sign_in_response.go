...
// ZeropsSignInResponse struct for ZeropsSignInResponse
type ZeropsSignInResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// URL to authenticate to Zerops
	Url string `json:"url"`
}
...
func (o ZeropsSignInResponse) MarshalJSON() ([]byte, error) {
...
type NullableZeropsSignInResponse struct {
	value *ZeropsSignInResponse
	isSet bool
}

func (v NullableZeropsSignInResponse) Get() *ZeropsSignInResponse {
	return v.value
}

func (v *NullableZeropsSignInResponse) Set(val *ZeropsSignInResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableZeropsSignInResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableZeropsSignInResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZeropsSignInResponse(val *ZeropsSignInResponse) *NullableZeropsSignInResponse {
	return &NullableZeropsSignInResponse{value: val, isSet: true}
}

func (v NullableZeropsSignInResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZeropsSignInResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
