...
// DataProtectionOfficerRequest struct for DataProtectionOfficerRequest
type DataProtectionOfficerRequest struct {
	// email
...
func NewDataProtectionOfficerRequest(email string, firstName string, lastName string, address Address, phoneNumber string) *DataProtectionOfficerRequest {
	this := DataProtectionOfficerRequest{}
	this.Email = email
...
func (o DataProtectionOfficerRequest) MarshalJSON() ([]byte, error) {
...
type NullableDataProtectionOfficerRequest struct {
	value *DataProtectionOfficerRequest
	isSet bool
}

func (v NullableDataProtectionOfficerRequest) Get() *DataProtectionOfficerRequest {
	return v.value
}

func (v *NullableDataProtectionOfficerRequest) Set(val *DataProtectionOfficerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDataProtectionOfficerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDataProtectionOfficerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataProtectionOfficerRequest(val *DataProtectionOfficerRequest) *NullableDataProtectionOfficerRequest {
	return &NullableDataProtectionOfficerRequest{value: val, isSet: true}
}

func (v NullableDataProtectionOfficerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataProtectionOfficerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
