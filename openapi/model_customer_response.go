...
type CustomerResponse struct {
	...
	Private CustomerTypePrivate `json:"private"`
	Business CustomerTypeBusiness `json:"business"`
	// Customer tax percentage
	...
	// The monthly revenue of the customer (How much the customer has to pay recurring each month)
	MonthlyRecurringRevenue float32 `json:"monthlyRecurringRevenue"`
}
...
// GetMonthlyRecurringRevenue returns the MonthlyRecurringRevenue field value
...
// GetMonthlyRecurringRevenueOk returns a tuple with the MonthlyRecurringRevenue field value
// and a boolean to check if the value has been set.
...
// SetMonthlyRecurringRevenue sets field value
...
func (o CustomerResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["monthlyRecurringRevenue"] = o.MonthlyRecurringRevenue
	}
