...
// CreateExpressCheckoutRequest struct for CreateExpressCheckoutRequest
type CreateExpressCheckoutRequest struct {
	// The customer locale.
	Locale string `json:"locale"`
	// The customer currency code.
	Currency string `json:"currency"`
	// The url to redirect to on on success.
...
func NewCreateExpressCheckoutRequest(locale string, currency string, returnUrl string, cancelUrl string) *CreateExpressCheckoutRequest {
	this := CreateExpressCheckoutRequest{}
	this.Locale = locale
...
func (o CreateExpressCheckoutRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreateExpressCheckoutRequest struct {
	value *CreateExpressCheckoutRequest
	isSet bool
}

func (v NullableCreateExpressCheckoutRequest) Get() *CreateExpressCheckoutRequest {
	return v.value
}

func (v *NullableCreateExpressCheckoutRequest) Set(val *CreateExpressCheckoutRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateExpressCheckoutRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateExpressCheckoutRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateExpressCheckoutRequest(val *CreateExpressCheckoutRequest) *NullableCreateExpressCheckoutRequest {
	return &NullableCreateExpressCheckoutRequest{value: val, isSet: true}
}

func (v NullableCreateExpressCheckoutRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateExpressCheckoutRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
