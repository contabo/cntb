...
// ListAvailablePaymentMethodResponse struct for ListAvailablePaymentMethodResponse
type ListAvailablePaymentMethodResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []AvailablePaymentMethodResponse `json:"data"`
...
func NewListAvailablePaymentMethodResponse(pagination PaginationMeta, data []AvailablePaymentMethodResponse, links Links) *ListAvailablePaymentMethodResponse {
	this := ListAvailablePaymentMethodResponse{}
...
func (o *ListAvailablePaymentMethodResponse) GetData() []AvailablePaymentMethodResponse {
	if o == nil {
		var ret []AvailablePaymentMethodResponse
		return ret
	}
...
func (o ListAvailablePaymentMethodResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAvailablePaymentMethodResponse struct {
	value *ListAvailablePaymentMethodResponse
	isSet bool
}

func (v NullableListAvailablePaymentMethodResponse) Get() *ListAvailablePaymentMethodResponse {
	return v.value
}

func (v *NullableListAvailablePaymentMethodResponse) Set(val *ListAvailablePaymentMethodResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAvailablePaymentMethodResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAvailablePaymentMethodResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAvailablePaymentMethodResponse(val *ListAvailablePaymentMethodResponse) *NullableListAvailablePaymentMethodResponse {
	return &NullableListAvailablePaymentMethodResponse{value: val, isSet: true}
}

func (v NullableListAvailablePaymentMethodResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAvailablePaymentMethodResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
