...
// TicketCreateResponse struct for TicketCreateResponse
...
func (o TicketCreateResponse) MarshalJSON() ([]byte, error) {
...
type NullableTicketCreateResponse struct {
	value *TicketCreateResponse
	isSet bool
}

func (v NullableTicketCreateResponse) Get() *TicketCreateResponse {
	return v.value
}

func (v *NullableTicketCreateResponse) Set(val *TicketCreateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTicketCreateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTicketCreateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTicketCreateResponse(val *TicketCreateResponse) *NullableTicketCreateResponse {
	return &NullableTicketCreateResponse{value: val, isSet: true}
}

func (v NullableTicketCreateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTicketCreateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
