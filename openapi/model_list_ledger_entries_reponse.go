...
// ListLedgerEntriesReponse struct for ListLedgerEntriesReponse
type ListLedgerEntriesReponse struct {
...
func (o ListLedgerEntriesReponse) MarshalJSON() ([]byte, error) {
...
type NullableListLedgerEntriesReponse struct {
	value *ListLedgerEntriesReponse
	isSet bool
}

func (v NullableListLedgerEntriesReponse) Get() *ListLedgerEntriesReponse {
	return v.value
}

func (v *NullableListLedgerEntriesReponse) Set(val *ListLedgerEntriesReponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListLedgerEntriesReponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListLedgerEntriesReponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListLedgerEntriesReponse(val *ListLedgerEntriesReponse) *NullableListLedgerEntriesReponse {
	return &NullableListLedgerEntriesReponse{value: val, isSet: true}
}

func (v NullableListLedgerEntriesReponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListLedgerEntriesReponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
