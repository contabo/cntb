...
// ZeropsUserResponse struct for ZeropsUserResponse
type ZeropsUserResponse struct {
...
func (o ZeropsUserResponse) MarshalJSON() ([]byte, error) {
...
type NullableZeropsUserResponse struct {
	value *ZeropsUserResponse
	isSet bool
}

func (v NullableZeropsUserResponse) Get() *ZeropsUserResponse {
	return v.value
}

func (v *NullableZeropsUserResponse) Set(val *ZeropsUserResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableZeropsUserResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableZeropsUserResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZeropsUserResponse(val *ZeropsUserResponse) *NullableZeropsUserResponse {
	return &NullableZeropsUserResponse{value: val, isSet: true}
}

func (v NullableZeropsUserResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZeropsUserResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
