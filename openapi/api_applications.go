...
func (r ApiListApplicationsRequest) XRequestId(xRequestId string) ApiListApplicationsRequest {
	r.xRequestId = &xRequestId
	return r
}
// Identifier to trace group of requests.
func (r ApiListApplicationsRequest) XTraceId(xTraceId string) ApiListApplicationsRequest {
	r.xTraceId = &xTraceId
	return r
}
...
func (r ApiListApplicationsRequest) Size(size int64) ApiListApplicationsRequest {
	r.size = &size
	return r
}
// Specify fields and ordering (ASC for ascending, DESC for descending) in following format &#x60;field:ASC|DESC&#x60;.
func (r ApiListApplicationsRequest) OrderBy(orderBy []string) ApiListApplicationsRequest {
	r.orderBy = &orderBy
	return r
}
...
// The ID of the image
func (r ApiListApplicationsRequest) ImageId(imageId string) ApiListApplicationsRequest {
	r.imageId = &imageId
	return r
}
// Application type
func (r ApiListApplicationsRequest) ApplicationType(applicationType string) ApiListApplicationsRequest {
	r.applicationType = &applicationType
	return r
}

func (r ApiListApplicationsRequest) Execute() (ListApplicationsResponse, *_nethttp.Response, error) {
	return r.ApiService.ListApplicationsExecute(r)
}

/*
ListApplications Retrieve Applications
...
*/
func (a *ApplicationsApiService) ListApplications(ctx _context.Context) ApiListApplicationsRequest {
	return ApiListApplicationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ApplicationsApiService) ListApplicationsExecute(r ApiListApplicationsRequest) (ListApplicationsResponse, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/v1/compute/applications"
	...
	if r.applicationType != nil {
		localVarQueryParams.Add("applicationType", parameterToString(*r.applicationType, ""))
	}
