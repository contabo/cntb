...
// TextSnippetResponse struct for TextSnippetResponse
type TextSnippetResponse struct {
...
// GetReferenceTitle returns the ReferenceTitle field value
func (o *TextSnippetResponse) GetReferenceTitle() string {
	...
	return o.ReferenceTitle
}

// GetReferenceTitleOk returns a tuple with the ReferenceTitle field value
// and a boolean to check if the value has been set.
func (o *TextSnippetResponse) GetReferenceTitleOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ReferenceTitle, true
}

// SetReferenceTitle sets field value
...
func (o TextSnippetResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["referenceTitle"] = o.ReferenceTitle
	}
	if true {
...
type NullableTextSnippetResponse struct {
	value *TextSnippetResponse
	isSet bool
}

func (v NullableTextSnippetResponse) Get() *TextSnippetResponse {
	return v.value
}

func (v *NullableTextSnippetResponse) Set(val *TextSnippetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTextSnippetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTextSnippetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextSnippetResponse(val *TextSnippetResponse) *NullableTextSnippetResponse {
	return &NullableTextSnippetResponse{value: val, isSet: true}
}

func (v NullableTextSnippetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextSnippetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
