...
// DpaResponse struct for DpaResponse
type DpaResponse struct {
...
func (o DpaResponse) MarshalJSON() ([]byte, error) {
...
type NullableDpaResponse struct {
	value *DpaResponse
	isSet bool
}

func (v NullableDpaResponse) Get() *DpaResponse {
	return v.value
}

func (v *NullableDpaResponse) Set(val *DpaResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDpaResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDpaResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpaResponse(val *DpaResponse) *NullableDpaResponse {
	return &NullableDpaResponse{value: val, isSet: true}
}

func (v NullableDpaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpaResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
