...
// AddOnTypeResponse struct for AddOnTypeResponse
...
func (o AddOnTypeResponse) MarshalJSON() ([]byte, error) {
...
type NullableAddOnTypeResponse struct {
	value *AddOnTypeResponse
	isSet bool
}

func (v NullableAddOnTypeResponse) Get() *AddOnTypeResponse {
	return v.value
}

func (v *NullableAddOnTypeResponse) Set(val *AddOnTypeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddOnTypeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddOnTypeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddOnTypeResponse(val *AddOnTypeResponse) *NullableAddOnTypeResponse {
	return &NullableAddOnTypeResponse{value: val, isSet: true}
}

func (v NullableAddOnTypeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddOnTypeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
