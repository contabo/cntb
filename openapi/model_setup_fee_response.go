...
// SetupFeeResponse struct for SetupFeeResponse
type SetupFeeResponse struct {
...
func (o SetupFeeResponse) MarshalJSON() ([]byte, error) {
...
type NullableSetupFeeResponse struct {
	value *SetupFeeResponse
	isSet bool
}

func (v NullableSetupFeeResponse) Get() *SetupFeeResponse {
	return v.value
}

func (v *NullableSetupFeeResponse) Set(val *SetupFeeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSetupFeeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSetupFeeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetupFeeResponse(val *SetupFeeResponse) *NullableSetupFeeResponse {
	return &NullableSetupFeeResponse{value: val, isSet: true}
}

func (v NullableSetupFeeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetupFeeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
