...
// CreateDpaRequest struct for CreateDpaRequest
type CreateDpaRequest struct {
	...
	DataProtectionOfficer *DataProtectionOfficerRequest `json:"dataProtectionOfficer,omitempty"`
	// DPA Service Id
...
// SetDataProtectionOfficer gets a reference to the given DataProtectionOfficerRequest and assigns it to the DataProtectionOfficer field.
...
func (o CreateDpaRequest) MarshalJSON() ([]byte, error) {
...
type NullableCreateDpaRequest struct {
	value *CreateDpaRequest
	isSet bool
}

func (v NullableCreateDpaRequest) Get() *CreateDpaRequest {
	return v.value
}

func (v *NullableCreateDpaRequest) Set(val *CreateDpaRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDpaRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDpaRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDpaRequest(val *CreateDpaRequest) *NullableCreateDpaRequest {
	return &NullableCreateDpaRequest{value: val, isSet: true}
}

func (v NullableCreateDpaRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDpaRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
