...
// UpdateObjectStorageResponseData struct for UpdateObjectStorageResponseData
type UpdateObjectStorageResponseData struct {
...
func NewUpdateObjectStorageResponseData(tenantId string, customerId string, objectStorageId string, createdDate string, dataCenter string, autoScaling AutoScalingTypeResponse, s3Url string, status string, totalPurchasedSpaceTB float64, region string) *UpdateObjectStorageResponseData {
	this := UpdateObjectStorageResponseData{}
...
func (o UpdateObjectStorageResponseData) MarshalJSON() ([]byte, error) {
...
type NullableUpdateObjectStorageResponseData struct {
	value *UpdateObjectStorageResponseData
	isSet bool
}

func (v NullableUpdateObjectStorageResponseData) Get() *UpdateObjectStorageResponseData {
	return v.value
}

func (v *NullableUpdateObjectStorageResponseData) Set(val *UpdateObjectStorageResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateObjectStorageResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateObjectStorageResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateObjectStorageResponseData(val *UpdateObjectStorageResponseData) *NullableUpdateObjectStorageResponseData {
	return &NullableUpdateObjectStorageResponseData{value: val, isSet: true}
}

func (v NullableUpdateObjectStorageResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateObjectStorageResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
