...
// DpaResponseData struct for DpaResponseData
type DpaResponseData struct {
	...
	ProcessedDataType ProcessedDataType `json:"processedDataType"`
	PersonalData PersonalData `json:"personalData"`
	AffectedPersons AffectedPersons `json:"affectedPersons"`
	DataProtectionOfficer DataProtectionOfficerRequest `json:"dataProtectionOfficer"`
	// DPA Service Id
	DpaServiceId string `json:"dpaServiceId"`
	// The creation date time for the dpa
	CreatedDate time.Time `json:"createdDate"`
	// The conclusion date time for the dpa
	ConcludedDate time.Time `json:"concludedDate"`
	// The invalidation date time for the dpa
	InvalidDate time.Time `json:"invalidDate"`
	// The archiving date time for the dpa
	ArchivedDate time.Time `json:"archivedDate"`
	// The service name and subscriptionId
	ServiceName string `json:"serviceName"`
	// The cancel date time for the service the dpa covers
...
func NewDpaResponseData(tenantId string, customerId string, dpaId string, processedDataType ProcessedDataType, personalData PersonalData, affectedPersons AffectedPersons, dataProtectionOfficer DataProtectionOfficerRequest, dpaServiceId string, createdDate time.Time, concludedDate time.Time, invalidDate time.Time, archivedDate time.Time, serviceName string, serviceCancelDate time.Time, status string, serviceDisplayName string) *DpaResponseData {
	...
	this.DpaServiceId = dpaServiceId
...
// GetDpaId returns the DpaId field value
...
// GetDpaIdOk returns a tuple with the DpaId field value
// and a boolean to check if the value has been set.
...
// SetDpaId sets field value
func (o *DpaResponseData) SetDpaId(v string) {
	o.DpaId = v
}

// GetProcessedDataType returns the ProcessedDataType field value
func (o *DpaResponseData) GetProcessedDataType() ProcessedDataType {
	if o == nil {
		var ret ProcessedDataType
		return ret
	}

	return o.ProcessedDataType
}

// GetProcessedDataTypeOk returns a tuple with the ProcessedDataType field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetProcessedDataTypeOk() (*ProcessedDataType, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ProcessedDataType, true
}

// SetProcessedDataType sets field value
func (o *DpaResponseData) SetProcessedDataType(v ProcessedDataType) {
	o.ProcessedDataType = v
}

// GetPersonalData returns the PersonalData field value
...
// GetPersonalDataOk returns a tuple with the PersonalData field value
// and a boolean to check if the value has been set.
...
// SetPersonalData sets field value
func (o *DpaResponseData) SetPersonalData(v PersonalData) {
	o.PersonalData = v
}

// GetAffectedPersons returns the AffectedPersons field value
func (o *DpaResponseData) GetAffectedPersons() AffectedPersons {
	if o == nil {
		var ret AffectedPersons
		return ret
	}

	return o.AffectedPersons
}

// GetAffectedPersonsOk returns a tuple with the AffectedPersons field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetAffectedPersonsOk() (*AffectedPersons, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AffectedPersons, true
}

// SetAffectedPersons sets field value
...
func (o *DpaResponseData) GetDataProtectionOfficer() DataProtectionOfficerRequest {
	if o == nil {
		var ret DataProtectionOfficerRequest
		return ret
	}
...
// GetDpaServiceId returns the DpaServiceId field value
func (o *DpaResponseData) GetDpaServiceId() string {
	...
	return o.DpaServiceId
}

// GetDpaServiceIdOk returns a tuple with the DpaServiceId field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetDpaServiceIdOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.DpaServiceId, true
}

// SetDpaServiceId sets field value
...
// GetConcludedDate returns the ConcludedDate field value
func (o *DpaResponseData) GetConcludedDate() time.Time {
	...
	return o.ConcludedDate
}

// GetConcludedDateOk returns a tuple with the ConcludedDate field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetConcludedDateOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ConcludedDate, true
}

// SetConcludedDate sets field value
func (o *DpaResponseData) SetConcludedDate(v time.Time) {
	o.ConcludedDate = v
}

// GetInvalidDate returns the InvalidDate field value
...
// GetInvalidDateOk returns a tuple with the InvalidDate field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetInvalidDateOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.InvalidDate, true
}

// SetInvalidDate sets field value
func (o *DpaResponseData) SetInvalidDate(v time.Time) {
	o.InvalidDate = v
}

// GetArchivedDate returns the ArchivedDate field value
...
// GetArchivedDateOk returns a tuple with the ArchivedDate field value
// and a boolean to check if the value has been set.
...
// SetArchivedDate sets field value
...
// GetServiceCancelDate returns the ServiceCancelDate field value
func (o *DpaResponseData) GetServiceCancelDate() time.Time {
	...
	return o.ServiceCancelDate
}

// GetServiceCancelDateOk returns a tuple with the ServiceCancelDate field value
// and a boolean to check if the value has been set.
func (o *DpaResponseData) GetServiceCancelDateOk() (*time.Time, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ServiceCancelDate, true
}

// SetServiceCancelDate sets field value
func (o *DpaResponseData) SetServiceCancelDate(v time.Time) {
	o.ServiceCancelDate = v
}
...
func (o DpaResponseData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["dpaId"] = o.DpaId
	}
	if true {
		toSerialize["processedDataType"] = o.ProcessedDataType
	}
	if true {
		toSerialize["personalData"] = o.PersonalData
	}
	if true {
		toSerialize["affectedPersons"] = o.AffectedPersons
	}
	if true {
		toSerialize["dataProtectionOfficer"] = o.DataProtectionOfficer
	}
	if true {
		toSerialize["dpaServiceId"] = o.DpaServiceId
	}
	if true {
		toSerialize["createdDate"] = o.CreatedDate
	}
	if true {
		toSerialize["concludedDate"] = o.ConcludedDate
	}
	if true {
		toSerialize["invalidDate"] = o.InvalidDate
	}
	if true {
	...
	if true {
		toSerialize["serviceCancelDate"] = o.ServiceCancelDate
	}
	if true {
...
type NullableDpaResponseData struct {
	value *DpaResponseData
	isSet bool
}

func (v NullableDpaResponseData) Get() *DpaResponseData {
	return v.value
}

func (v *NullableDpaResponseData) Set(val *DpaResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableDpaResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableDpaResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpaResponseData(val *DpaResponseData) *NullableDpaResponseData {
	return &NullableDpaResponseData{value: val, isSet: true}
}

func (v NullableDpaResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpaResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
