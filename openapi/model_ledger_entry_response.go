...
// LedgerEntryResponse struct for LedgerEntryResponse
type LedgerEntryResponse struct {
	...
	// Ledger entry id
	LedgerEntryId float32 `json:"ledgerEntryId"`
	// Ledger entry subscription id
	SubscriptionId float32 `json:"subscriptionId"`
	// The transaction date
	TransactionDate time.Time `json:"transactionDate"`
	// The billing start the for the service
	BillingStartDate time.Time `json:"billingStartDate"`
	// The billing end date the for the service
	BillingEndDate time.Time `json:"billingEndDate"`
	// The monthly price of the service
	GrossMonthlyPrice float32 `json:"grossMonthlyPrice"`
	// The subject of the transaction
	Subject string `json:"subject"`
	// Your balance after you paid for the service
	BalanceAfter float32 `json:"balanceAfter"`
	// The description of the transaction
	Description string `json:"description"`
	Currency string `json:"currency"`
	// The price of the service from the moment you have purchased it
...
func NewLedgerEntryResponse(tenantId string, customerId string, ledgerEntryId float32, subscriptionId float32, transactionDate time.Time, billingStartDate time.Time, billingEndDate time.Time, grossMonthlyPrice float32, subject string, balanceAfter float32, description string, currency string, grossAmount float32, type_ string) *LedgerEntryResponse {
	...
	this.GrossMonthlyPrice = grossMonthlyPrice
...
// GetLedgerEntryId returns the LedgerEntryId field value
func (o *LedgerEntryResponse) GetLedgerEntryId() float32 {
	...
	return o.LedgerEntryId
}

// GetLedgerEntryIdOk returns a tuple with the LedgerEntryId field value
// and a boolean to check if the value has been set.
func (o *LedgerEntryResponse) GetLedgerEntryIdOk() (*float32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.LedgerEntryId, true
}

// SetLedgerEntryId sets field value
...
// GetGrossMonthlyPrice returns the GrossMonthlyPrice field value
func (o *LedgerEntryResponse) GetGrossMonthlyPrice() float32 {
	...
	return o.GrossMonthlyPrice
}

// GetGrossMonthlyPriceOk returns a tuple with the GrossMonthlyPrice field value
// and a boolean to check if the value has been set.
func (o *LedgerEntryResponse) GetGrossMonthlyPriceOk() (*float32, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.GrossMonthlyPrice, true
}

// SetGrossMonthlyPrice sets field value
func (o *LedgerEntryResponse) SetGrossMonthlyPrice(v float32) {
	o.GrossMonthlyPrice = v
}
...
func (o LedgerEntryResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["ledgerEntryId"] = o.LedgerEntryId
	}
	if true {
	...
	if true {
		toSerialize["grossMonthlyPrice"] = o.GrossMonthlyPrice
	}
	if true {
...
type NullableLedgerEntryResponse struct {
	value *LedgerEntryResponse
	isSet bool
}

func (v NullableLedgerEntryResponse) Get() *LedgerEntryResponse {
	return v.value
}

func (v *NullableLedgerEntryResponse) Set(val *LedgerEntryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLedgerEntryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLedgerEntryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLedgerEntryResponse(val *LedgerEntryResponse) *NullableLedgerEntryResponse {
	return &NullableLedgerEntryResponse{value: val, isSet: true}
}

func (v NullableLedgerEntryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLedgerEntryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
