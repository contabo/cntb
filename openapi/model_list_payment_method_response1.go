...
// ListPaymentMethodResponse1 struct for ListPaymentMethodResponse1
type ListPaymentMethodResponse1 struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []PaymentMethodResponse1 `json:"data"`
...
func NewListPaymentMethodResponse1(pagination PaginationMeta, data []PaymentMethodResponse1, links Links) *ListPaymentMethodResponse1 {
	this := ListPaymentMethodResponse1{}
...
func (o *ListPaymentMethodResponse1) GetData() []PaymentMethodResponse1 {
	if o == nil {
		var ret []PaymentMethodResponse1
		return ret
	}
...
func (o ListPaymentMethodResponse1) MarshalJSON() ([]byte, error) {
...
type NullableListPaymentMethodResponse1 struct {
	value *ListPaymentMethodResponse1
	isSet bool
}

func (v NullableListPaymentMethodResponse1) Get() *ListPaymentMethodResponse1 {
	return v.value
}

func (v *NullableListPaymentMethodResponse1) Set(val *ListPaymentMethodResponse1) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentMethodResponse1) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentMethodResponse1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentMethodResponse1(val *ListPaymentMethodResponse1) *NullableListPaymentMethodResponse1 {
	return &NullableListPaymentMethodResponse1{value: val, isSet: true}
}

func (v NullableListPaymentMethodResponse1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentMethodResponse1) UnmarshalJSON(src []byte) error {
	v.isSet = true
