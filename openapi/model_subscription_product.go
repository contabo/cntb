...
type SubscriptionProduct struct {
	...
	// Logo of subscription product
	ProductLogo string `json:"productLogo"`
	// Activiation code of subscription e.g. for plesk
...
// GetProductLogo returns the ProductLogo field value
func (o *SubscriptionProduct) GetProductLogo() string {
	...
	return o.ProductLogo
}

// GetProductLogoOk returns a tuple with the ProductLogo field value
// and a boolean to check if the value has been set.
func (o *SubscriptionProduct) GetProductLogoOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.ProductLogo, true
}

// SetProductLogo sets field value
...
func (o SubscriptionProduct) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["productLogo"] = o.ProductLogo
	}
	if true {
