...
// UpdateObjectStorageResponse struct for UpdateObjectStorageResponse
type UpdateObjectStorageResponse struct {
	Links SelfLinks `json:"_links"`
	Data []UpdateObjectStorageResponseData `json:"data"`
}
...
func NewUpdateObjectStorageResponse(links SelfLinks, data []UpdateObjectStorageResponseData) *UpdateObjectStorageResponse {
	this := UpdateObjectStorageResponse{}
	this.Links = links
	this.Data = data
	return &this
}
...
func (o *UpdateObjectStorageResponse) GetData() []UpdateObjectStorageResponseData {
	if o == nil {
		var ret []UpdateObjectStorageResponseData
		return ret
	}
...
func (o UpdateObjectStorageResponse) MarshalJSON() ([]byte, error) {
...
type NullableUpdateObjectStorageResponse struct {
	value *UpdateObjectStorageResponse
	isSet bool
}

func (v NullableUpdateObjectStorageResponse) Get() *UpdateObjectStorageResponse {
	return v.value
}

func (v *NullableUpdateObjectStorageResponse) Set(val *UpdateObjectStorageResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateObjectStorageResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateObjectStorageResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateObjectStorageResponse(val *UpdateObjectStorageResponse) *NullableUpdateObjectStorageResponse {
	return &NullableUpdateObjectStorageResponse{value: val, isSet: true}
}

func (v NullableUpdateObjectStorageResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateObjectStorageResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
