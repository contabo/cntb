...
// FindCustomerResponse struct for FindCustomerResponse
...
func (o FindCustomerResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindCustomerResponse struct {
	value *FindCustomerResponse
	isSet bool
}

func (v NullableFindCustomerResponse) Get() *FindCustomerResponse {
	return v.value
}

func (v *NullableFindCustomerResponse) Set(val *FindCustomerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindCustomerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindCustomerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindCustomerResponse(val *FindCustomerResponse) *NullableFindCustomerResponse {
	return &NullableFindCustomerResponse{value: val, isSet: true}
}

func (v NullableFindCustomerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindCustomerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
