...
// ListTextSnippetsResponse struct for ListTextSnippetsResponse
type ListTextSnippetsResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	// TODO: add description
	Data []TextSnippetResponse `json:"data"`
	// TODO: add description
...
func (o ListTextSnippetsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListTextSnippetsResponse struct {
	value *ListTextSnippetsResponse
	isSet bool
}

func (v NullableListTextSnippetsResponse) Get() *ListTextSnippetsResponse {
	return v.value
}

func (v *NullableListTextSnippetsResponse) Set(val *ListTextSnippetsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTextSnippetsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTextSnippetsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTextSnippetsResponse(val *ListTextSnippetsResponse) *NullableListTextSnippetsResponse {
	return &NullableListTextSnippetsResponse{value: val, isSet: true}
}

func (v NullableListTextSnippetsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTextSnippetsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
