...
func (o ListDpaResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDpaResponse struct {
	value *ListDpaResponse
	isSet bool
}

func (v NullableListDpaResponse) Get() *ListDpaResponse {
	return v.value
}

func (v *NullableListDpaResponse) Set(val *ListDpaResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDpaResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDpaResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDpaResponse(val *ListDpaResponse) *NullableListDpaResponse {
	return &NullableListDpaResponse{value: val, isSet: true}
}

func (v NullableListDpaResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDpaResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
