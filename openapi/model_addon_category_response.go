...
// AddonCategoryResponse struct for AddonCategoryResponse
type AddonCategoryResponse struct {
	...
	// Groups of AddOn types in this category
	Groups []AddonGroupResponse `json:"groups"`
}
...
func (o AddonCategoryResponse) MarshalJSON() ([]byte, error) {
...
type NullableAddonCategoryResponse struct {
	value *AddonCategoryResponse
	isSet bool
}

func (v NullableAddonCategoryResponse) Get() *AddonCategoryResponse {
	return v.value
}

func (v *NullableAddonCategoryResponse) Set(val *AddonCategoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddonCategoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddonCategoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddonCategoryResponse(val *AddonCategoryResponse) *NullableAddonCategoryResponse {
	return &NullableAddonCategoryResponse{value: val, isSet: true}
}

func (v NullableAddonCategoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddonCategoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
