...
// GetPendingCode returns the PendingCode field value
func (o *OrderResponseData) GetPendingCode() string {
	...
	return o.PendingCode
}

// GetPendingCodeOk returns a tuple with the PendingCode field value
// and a boolean to check if the value has been set.
func (o *OrderResponseData) GetPendingCodeOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.PendingCode, true
}

// SetPendingCode sets field value
func (o *OrderResponseData) SetPendingCode(v string) {
	o.PendingCode = v
}

// GetPendingReason returns the PendingReason field value
...
// GetPendingReasonOk returns a tuple with the PendingReason field value
// and a boolean to check if the value has been set.
...
// SetPendingReason sets field value
...
func (o OrderResponseData) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["pendingCode"] = o.PendingCode
	}
	if true {
		toSerialize["pendingReason"] = o.PendingReason
	}
	if true {
