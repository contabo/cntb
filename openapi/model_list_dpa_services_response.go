...
// ListDpaServicesResponse struct for ListDpaServicesResponse
type ListDpaServicesResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []DpaServiceResponse `json:"data"`
...
func (o ListDpaServicesResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDpaServicesResponse struct {
	value *ListDpaServicesResponse
	isSet bool
}

func (v NullableListDpaServicesResponse) Get() *ListDpaServicesResponse {
	return v.value
}

func (v *NullableListDpaServicesResponse) Set(val *ListDpaServicesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDpaServicesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDpaServicesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDpaServicesResponse(val *ListDpaServicesResponse) *NullableListDpaServicesResponse {
	return &NullableListDpaServicesResponse{value: val, isSet: true}
}

func (v NullableListDpaServicesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDpaServicesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
