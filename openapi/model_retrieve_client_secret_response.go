...
// RetrieveClientSecretResponse struct for RetrieveClientSecretResponse
type RetrieveClientSecretResponse struct {
	Data []RetrieveClientSecretResponseData `json:"data"`
...
func NewRetrieveClientSecretResponse(data []RetrieveClientSecretResponseData, links SelfLinks) *RetrieveClientSecretResponse {
	this := RetrieveClientSecretResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *RetrieveClientSecretResponse) GetData() []RetrieveClientSecretResponseData {
	if o == nil {
		var ret []RetrieveClientSecretResponseData
		return ret
	}
...
func (o RetrieveClientSecretResponse) MarshalJSON() ([]byte, error) {
...
type NullableRetrieveClientSecretResponse struct {
	value *RetrieveClientSecretResponse
	isSet bool
}

func (v NullableRetrieveClientSecretResponse) Get() *RetrieveClientSecretResponse {
	return v.value
}

func (v *NullableRetrieveClientSecretResponse) Set(val *RetrieveClientSecretResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveClientSecretResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveClientSecretResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveClientSecretResponse(val *RetrieveClientSecretResponse) *NullableRetrieveClientSecretResponse {
	return &NullableRetrieveClientSecretResponse{value: val, isSet: true}
}

func (v NullableRetrieveClientSecretResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveClientSecretResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
