...
// Filter by serviceType: [object-storage, vserver, co-location , ftp, webspace-package, bare-metal]
func (r ApiListDpaServicesRequest) ServiceType(serviceType string) ApiListDpaServicesRequest {
