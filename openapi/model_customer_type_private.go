...
// CustomerTypePrivate struct for CustomerTypePrivate
type CustomerTypePrivate struct {
	// Customer first name
...
func (o CustomerTypePrivate) MarshalJSON() ([]byte, error) {
...
type NullableCustomerTypePrivate struct {
	value *CustomerTypePrivate
	isSet bool
}

func (v NullableCustomerTypePrivate) Get() *CustomerTypePrivate {
	return v.value
}

func (v *NullableCustomerTypePrivate) Set(val *CustomerTypePrivate) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerTypePrivate) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerTypePrivate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerTypePrivate(val *CustomerTypePrivate) *NullableCustomerTypePrivate {
	return &NullableCustomerTypePrivate{value: val, isSet: true}
}

func (v NullableCustomerTypePrivate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerTypePrivate) UnmarshalJSON(src []byte) error {
	v.isSet = true
