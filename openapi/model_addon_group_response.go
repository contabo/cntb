...
// AddonGroupResponse struct for AddonGroupResponse
type AddonGroupResponse struct {
	...
	// AddOn slugs with this group
	AddonSlugs []string `json:"addonSlugs"`
	// AddOn types in this group
	AddonTypes []AddOnTypeResponse `json:"addonTypes"`
}
...
// GetAddonSlugs returns the AddonSlugs field value
...
// GetAddonSlugsOk returns a tuple with the AddonSlugs field value
// and a boolean to check if the value has been set.
func (o *AddonGroupResponse) GetAddonSlugsOk() (*[]string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AddonSlugs, true
}

// SetAddonSlugs sets field value
func (o *AddonGroupResponse) SetAddonSlugs(v []string) {
	o.AddonSlugs = v
}

// GetAddonTypes returns the AddonTypes field value
func (o *AddonGroupResponse) GetAddonTypes() []AddOnTypeResponse {
	if o == nil {
		var ret []AddOnTypeResponse
		return ret
	}
...
// GetAddonTypesOk returns a tuple with the AddonTypes field value
// and a boolean to check if the value has been set.
func (o *AddonGroupResponse) GetAddonTypesOk() (*[]AddOnTypeResponse, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.AddonTypes, true
}

// SetAddonTypes sets field value
func (o *AddonGroupResponse) SetAddonTypes(v []AddOnTypeResponse) {
	o.AddonTypes = v
}

func (o AddonGroupResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["addonSlugs"] = o.AddonSlugs
	}
	if true {
		toSerialize["addonTypes"] = o.AddonTypes
	}
	return json.Marshal(toSerialize)
}

type NullableAddonGroupResponse struct {
	value *AddonGroupResponse
	isSet bool
}

func (v NullableAddonGroupResponse) Get() *AddonGroupResponse {
	return v.value
}

func (v *NullableAddonGroupResponse) Set(val *AddonGroupResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddonGroupResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddonGroupResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddonGroupResponse(val *AddonGroupResponse) *NullableAddonGroupResponse {
	return &NullableAddonGroupResponse{value: val, isSet: true}
}

func (v NullableAddonGroupResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddonGroupResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
