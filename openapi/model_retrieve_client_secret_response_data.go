...
// RetrieveClientSecretResponseData struct for RetrieveClientSecretResponseData
type RetrieveClientSecretResponseData struct {
...
func NewRetrieveClientSecretResponseData(tenantId string, customerId string, clientSecret string) *RetrieveClientSecretResponseData {
	this := RetrieveClientSecretResponseData{}
...
func (o RetrieveClientSecretResponseData) MarshalJSON() ([]byte, error) {
...
type NullableRetrieveClientSecretResponseData struct {
	value *RetrieveClientSecretResponseData
	isSet bool
}

func (v NullableRetrieveClientSecretResponseData) Get() *RetrieveClientSecretResponseData {
	return v.value
}

func (v *NullableRetrieveClientSecretResponseData) Set(val *RetrieveClientSecretResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRetrieveClientSecretResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRetrieveClientSecretResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRetrieveClientSecretResponseData(val *RetrieveClientSecretResponseData) *NullableRetrieveClientSecretResponseData {
	return &NullableRetrieveClientSecretResponseData{value: val, isSet: true}
}

func (v NullableRetrieveClientSecretResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRetrieveClientSecretResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
