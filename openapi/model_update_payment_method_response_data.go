...
// UpdatePaymentMethodResponseData struct for UpdatePaymentMethodResponseData
type UpdatePaymentMethodResponseData struct {
...
func NewUpdatePaymentMethodResponseData(tenantId string, customerId string, paymentType string, paymentId string) *UpdatePaymentMethodResponseData {
	this := UpdatePaymentMethodResponseData{}
...
func (o UpdatePaymentMethodResponseData) MarshalJSON() ([]byte, error) {
...
type NullableUpdatePaymentMethodResponseData struct {
	value *UpdatePaymentMethodResponseData
	isSet bool
}

func (v NullableUpdatePaymentMethodResponseData) Get() *UpdatePaymentMethodResponseData {
	return v.value
}

func (v *NullableUpdatePaymentMethodResponseData) Set(val *UpdatePaymentMethodResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePaymentMethodResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePaymentMethodResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePaymentMethodResponseData(val *UpdatePaymentMethodResponseData) *NullableUpdatePaymentMethodResponseData {
	return &NullableUpdatePaymentMethodResponseData{value: val, isSet: true}
}

func (v NullableUpdatePaymentMethodResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePaymentMethodResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
