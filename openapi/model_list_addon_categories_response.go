...
// ListAddonCategoriesResponse struct for ListAddonCategoriesResponse
type ListAddonCategoriesResponse struct {
	...
	Data []AddonCategoryResponse `json:"data"`
	// TODO: add description
...
func NewListAddonCategoriesResponse(pagination PaginationMeta, data []AddonCategoryResponse, links Links) *ListAddonCategoriesResponse {
	this := ListAddonCategoriesResponse{}
...
func (o ListAddonCategoriesResponse) MarshalJSON() ([]byte, error) {
...
type NullableListAddonCategoriesResponse struct {
	value *ListAddonCategoriesResponse
	isSet bool
}

func (v NullableListAddonCategoriesResponse) Get() *ListAddonCategoriesResponse {
	return v.value
}

func (v *NullableListAddonCategoriesResponse) Set(val *ListAddonCategoriesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListAddonCategoriesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListAddonCategoriesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListAddonCategoriesResponse(val *ListAddonCategoriesResponse) *NullableListAddonCategoriesResponse {
	return &NullableListAddonCategoriesResponse{value: val, isSet: true}
}

func (v NullableListAddonCategoriesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListAddonCategoriesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
