...
// ListDpaAuditResponse struct for ListDpaAuditResponse
type ListDpaAuditResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []DpaAuditResponse `json:"data"`
...
func (o ListDpaAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableListDpaAuditResponse struct {
	value *ListDpaAuditResponse
	isSet bool
}

func (v NullableListDpaAuditResponse) Get() *ListDpaAuditResponse {
	return v.value
}

func (v *NullableListDpaAuditResponse) Set(val *ListDpaAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListDpaAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListDpaAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListDpaAuditResponse(val *ListDpaAuditResponse) *NullableListDpaAuditResponse {
	return &NullableListDpaAuditResponse{value: val, isSet: true}
}

func (v NullableListDpaAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListDpaAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
