...
// FindSubscriptionResponse struct for FindSubscriptionResponse
type FindSubscriptionResponse struct {
	Data []ExtendedSubscriptionResponse `json:"data"`
...
func (o *FindSubscriptionResponse) GetData() []ExtendedSubscriptionResponse {
	if o == nil {
		var ret []ExtendedSubscriptionResponse
		return ret
	}
...
func (o FindSubscriptionResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindSubscriptionResponse struct {
	value *FindSubscriptionResponse
	isSet bool
}

func (v NullableFindSubscriptionResponse) Get() *FindSubscriptionResponse {
	return v.value
}

func (v *NullableFindSubscriptionResponse) Set(val *FindSubscriptionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindSubscriptionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindSubscriptionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindSubscriptionResponse(val *FindSubscriptionResponse) *NullableFindSubscriptionResponse {
	return &NullableFindSubscriptionResponse{value: val, isSet: true}
}

func (v NullableFindSubscriptionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindSubscriptionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
