...
// CustomerEmail struct for CustomerEmail
...
func (o CustomerEmail) MarshalJSON() ([]byte, error) {
...
type NullableCustomerEmail struct {
	value *CustomerEmail
	isSet bool
}

func (v NullableCustomerEmail) Get() *CustomerEmail {
	return v.value
}

func (v *NullableCustomerEmail) Set(val *CustomerEmail) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerEmail) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerEmail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerEmail(val *CustomerEmail) *NullableCustomerEmail {
	return &NullableCustomerEmail{value: val, isSet: true}
}

func (v NullableCustomerEmail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerEmail) UnmarshalJSON(src []byte) error {
	v.isSet = true
