...
// SetDefaultFirewallResponse struct for SetDefaultFirewallResponse
type SetDefaultFirewallResponse struct {
...
func NewSetDefaultFirewallResponse(data []FirewallResponse, links SelfLinks) *SetDefaultFirewallResponse {
	this := SetDefaultFirewallResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o SetDefaultFirewallResponse) MarshalJSON() ([]byte, error) {
...
type NullableSetDefaultFirewallResponse struct {
	value *SetDefaultFirewallResponse
	isSet bool
}

func (v NullableSetDefaultFirewallResponse) Get() *SetDefaultFirewallResponse {
	return v.value
}

func (v *NullableSetDefaultFirewallResponse) Set(val *SetDefaultFirewallResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSetDefaultFirewallResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSetDefaultFirewallResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetDefaultFirewallResponse(val *SetDefaultFirewallResponse) *NullableSetDefaultFirewallResponse {
	return &NullableSetDefaultFirewallResponse{value: val, isSet: true}
}

func (v NullableSetDefaultFirewallResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetDefaultFirewallResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
