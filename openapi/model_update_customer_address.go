...
func (o UpdateCustomerAddress) MarshalJSON() ([]byte, error) {
...
type NullableUpdateCustomerAddress struct {
	value *UpdateCustomerAddress
	isSet bool
}

func (v NullableUpdateCustomerAddress) Get() *UpdateCustomerAddress {
	return v.value
}

func (v *NullableUpdateCustomerAddress) Set(val *UpdateCustomerAddress) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCustomerAddress) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCustomerAddress) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCustomerAddress(val *UpdateCustomerAddress) *NullableUpdateCustomerAddress {
	return &NullableUpdateCustomerAddress{value: val, isSet: true}
}

func (v NullableUpdateCustomerAddress) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCustomerAddress) UnmarshalJSON(src []byte) error {
	v.isSet = true
