...
type CategoryResponse struct {
	...
	// Maximum available ips
	MaxIp int64 `json:"maxIp"`
...
// GetMaxIp returns the MaxIp field value
...
// GetMaxIpOk returns a tuple with the MaxIp field value
// and a boolean to check if the value has been set.
