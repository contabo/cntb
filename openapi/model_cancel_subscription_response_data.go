...
// CancelSubscriptionResponseData struct for CancelSubscriptionResponseData
type CancelSubscriptionResponseData struct {
...
func NewCancelSubscriptionResponseData(tenantId string, customerId string, cancelDate string) *CancelSubscriptionResponseData {
	this := CancelSubscriptionResponseData{}
...
func (o CancelSubscriptionResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCancelSubscriptionResponseData struct {
	value *CancelSubscriptionResponseData
	isSet bool
}

func (v NullableCancelSubscriptionResponseData) Get() *CancelSubscriptionResponseData {
	return v.value
}

func (v *NullableCancelSubscriptionResponseData) Set(val *CancelSubscriptionResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelSubscriptionResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelSubscriptionResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelSubscriptionResponseData(val *CancelSubscriptionResponseData) *NullableCancelSubscriptionResponseData {
	return &NullableCancelSubscriptionResponseData{value: val, isSet: true}
}

func (v NullableCancelSubscriptionResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelSubscriptionResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
