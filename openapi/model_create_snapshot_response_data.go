...
// CreateSnapshotResponseData struct for CreateSnapshotResponseData
type CreateSnapshotResponseData struct {
...
func NewCreateSnapshotResponseData(tenantId string, customerId string, snapshotId string, imageId string, imageName string) *CreateSnapshotResponseData {
	this := CreateSnapshotResponseData{}
...
func (o CreateSnapshotResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateSnapshotResponseData struct {
	value *CreateSnapshotResponseData
	isSet bool
}

func (v NullableCreateSnapshotResponseData) Get() *CreateSnapshotResponseData {
	return v.value
}

func (v *NullableCreateSnapshotResponseData) Set(val *CreateSnapshotResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSnapshotResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSnapshotResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSnapshotResponseData(val *CreateSnapshotResponseData) *NullableCreateSnapshotResponseData {
	return &NullableCreateSnapshotResponseData{value: val, isSet: true}
}

func (v NullableCreateSnapshotResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSnapshotResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
