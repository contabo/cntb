...
// OtherData struct for OtherData
type OtherData struct {
	// Toggle for other data
...
func (o OtherData) MarshalJSON() ([]byte, error) {
...
type NullableOtherData struct {
	value *OtherData
	isSet bool
}

func (v NullableOtherData) Get() *OtherData {
	return v.value
}

func (v *NullableOtherData) Set(val *OtherData) {
	v.value = val
	v.isSet = true
}

func (v NullableOtherData) IsSet() bool {
	return v.isSet
}

func (v *NullableOtherData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOtherData(val *OtherData) *NullableOtherData {
	return &NullableOtherData{value: val, isSet: true}
}

func (v NullableOtherData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOtherData) UnmarshalJSON(src []byte) error {
	v.isSet = true
