...
// DomainsTldsListResponse struct for DomainsTldsListResponse
type DomainsTldsListResponse struct {
	// Data about pagination like how many results, pages, page size.
	Pagination PaginationMeta `json:"_pagination"`
	Data []DomainTldsResponse `json:"data"`
...
func (o DomainsTldsListResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainsTldsListResponse struct {
	value *DomainsTldsListResponse
	isSet bool
}

func (v NullableDomainsTldsListResponse) Get() *DomainsTldsListResponse {
	return v.value
}

func (v *NullableDomainsTldsListResponse) Set(val *DomainsTldsListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainsTldsListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainsTldsListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainsTldsListResponse(val *DomainsTldsListResponse) *NullableDomainsTldsListResponse {
	return &NullableDomainsTldsListResponse{value: val, isSet: true}
}

func (v NullableDomainsTldsListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainsTldsListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
