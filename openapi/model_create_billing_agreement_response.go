...
// CreateBillingAgreementResponse struct for CreateBillingAgreementResponse
type CreateBillingAgreementResponse struct {
	Data []CreateBillingAgreementResponseData `json:"data"`
...
func NewCreateBillingAgreementResponse(data []CreateBillingAgreementResponseData, links SelfLinks) *CreateBillingAgreementResponse {
	this := CreateBillingAgreementResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CreateBillingAgreementResponse) GetData() []CreateBillingAgreementResponseData {
	if o == nil {
		var ret []CreateBillingAgreementResponseData
		return ret
	}
...
func (o CreateBillingAgreementResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateBillingAgreementResponse struct {
	value *CreateBillingAgreementResponse
	isSet bool
}

func (v NullableCreateBillingAgreementResponse) Get() *CreateBillingAgreementResponse {
	return v.value
}

func (v *NullableCreateBillingAgreementResponse) Set(val *CreateBillingAgreementResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateBillingAgreementResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateBillingAgreementResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateBillingAgreementResponse(val *CreateBillingAgreementResponse) *NullableCreateBillingAgreementResponse {
	return &NullableCreateBillingAgreementResponse{value: val, isSet: true}
}

func (v NullableCreateBillingAgreementResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateBillingAgreementResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
