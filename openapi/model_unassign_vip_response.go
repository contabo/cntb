...
// UnassignVipResponse struct for UnassignVipResponse
type UnassignVipResponse struct {
...
func (o UnassignVipResponse) MarshalJSON() ([]byte, error) {
...
type NullableUnassignVipResponse struct {
	value *UnassignVipResponse
	isSet bool
}

func (v NullableUnassignVipResponse) Get() *UnassignVipResponse {
	return v.value
}

func (v *NullableUnassignVipResponse) Set(val *UnassignVipResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUnassignVipResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUnassignVipResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnassignVipResponse(val *UnassignVipResponse) *NullableUnassignVipResponse {
	return &NullableUnassignVipResponse{value: val, isSet: true}
}

func (v NullableUnassignVipResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnassignVipResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
