...
// ListPaymentMethodResponse struct for ListPaymentMethodResponse
...
func NewListPaymentMethodResponse(data []PaymentMethodResponse, links SelfLinks) *ListPaymentMethodResponse {
	this := ListPaymentMethodResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o ListPaymentMethodResponse) MarshalJSON() ([]byte, error) {
...
type NullableListPaymentMethodResponse struct {
	value *ListPaymentMethodResponse
	isSet bool
}

func (v NullableListPaymentMethodResponse) Get() *ListPaymentMethodResponse {
	return v.value
}

func (v *NullableListPaymentMethodResponse) Set(val *ListPaymentMethodResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListPaymentMethodResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListPaymentMethodResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListPaymentMethodResponse(val *ListPaymentMethodResponse) *NullableListPaymentMethodResponse {
	return &NullableListPaymentMethodResponse{value: val, isSet: true}
}

func (v NullableListPaymentMethodResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListPaymentMethodResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
