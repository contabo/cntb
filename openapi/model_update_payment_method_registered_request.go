...
// UpdatePaymentMethodRegisteredRequest struct for UpdatePaymentMethodRegisteredRequest
type UpdatePaymentMethodRegisteredRequest struct {
	// Customer payment method
	PaymentMethod string `json:"paymentMethod"`
	// Account holder (only for direct debit)
	AccountHolder *string `json:"accountHolder,omitempty"`
	// IBAN (only for direct debit)
	Iban *string `json:"iban,omitempty"`
	// Setup intent ID from Stripe (only for credit card)
	SetiId *string `json:"setiId,omitempty"`
	// Token from PayPal (only for paypal_rt)
...
func NewUpdatePaymentMethodRegisteredRequest(paymentMethod string) *UpdatePaymentMethodRegisteredRequest {
	this := UpdatePaymentMethodRegisteredRequest{}
...
// GetSetiId returns the SetiId field value if set, zero value otherwise.
func (o *UpdatePaymentMethodRegisteredRequest) GetSetiId() string {
	if o == nil || o.SetiId == nil {
		var ret string
		return ret
	}
	return *o.SetiId
...
// GetSetiIdOk returns a tuple with the SetiId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdatePaymentMethodRegisteredRequest) GetSetiIdOk() (*string, bool) {
	if o == nil || o.SetiId == nil {
		return nil, false
	}
	return o.SetiId, true
}
...
// SetSetiId gets a reference to the given string and assigns it to the SetiId field.
...
func (o UpdatePaymentMethodRegisteredRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpdatePaymentMethodRegisteredRequest struct {
	value *UpdatePaymentMethodRegisteredRequest
	isSet bool
}

func (v NullableUpdatePaymentMethodRegisteredRequest) Get() *UpdatePaymentMethodRegisteredRequest {
	return v.value
}

func (v *NullableUpdatePaymentMethodRegisteredRequest) Set(val *UpdatePaymentMethodRegisteredRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdatePaymentMethodRegisteredRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdatePaymentMethodRegisteredRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdatePaymentMethodRegisteredRequest(val *UpdatePaymentMethodRegisteredRequest) *NullableUpdatePaymentMethodRegisteredRequest {
	return &NullableUpdatePaymentMethodRegisteredRequest{value: val, isSet: true}
}

func (v NullableUpdatePaymentMethodRegisteredRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdatePaymentMethodRegisteredRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
