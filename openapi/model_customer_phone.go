...
// CustomerPhone struct for CustomerPhone
...
func (o CustomerPhone) MarshalJSON() ([]byte, error) {
...
type NullableCustomerPhone struct {
	value *CustomerPhone
	isSet bool
}

func (v NullableCustomerPhone) Get() *CustomerPhone {
	return v.value
}

func (v *NullableCustomerPhone) Set(val *CustomerPhone) {
	v.value = val
	v.isSet = true
}

func (v NullableCustomerPhone) IsSet() bool {
	return v.isSet
}

func (v *NullableCustomerPhone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCustomerPhone(val *CustomerPhone) *NullableCustomerPhone {
	return &NullableCustomerPhone{value: val, isSet: true}
}

func (v NullableCustomerPhone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCustomerPhone) UnmarshalJSON(src []byte) error {
	v.isSet = true
