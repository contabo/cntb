...
type AddonResponse struct {
	PriceItem PriceItemResponse `json:"priceItem"`
	// TODO: add description
	Quantity int64 `json:"quantity"`
	// Capability of an addon
	Capability int64 `json:"capability"`
	// TODO: add description
	Type *string `json:"type,omitempty"`
	// List of addons to include/exclude.
...
// GetPriceItem returns the PriceItem field value
func (o *AddonResponse) GetPriceItem() PriceItemResponse {
	if o == nil {
		var ret PriceItemResponse
		return ret
	}
...
// GetPriceItemOk returns a tuple with the PriceItem field value
// and a boolean to check if the value has been set.
func (o *AddonResponse) GetPriceItemOk() (*PriceItemResponse, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.PriceItem, true
}

// SetPriceItem sets field value
...
func (o AddonResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["priceItem"] = o.PriceItem
	}
	if true {
