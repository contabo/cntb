...
type CreateCustomerRequest struct {
	...
	// Password must be between at least 8 characters long with 1 uppercase and 1 lowercase, 1 number and 1 special character.
	Password string `json:"password"`
	// The locale of the customer.
	Locale string `json:"locale"`
	// The currency of the customer.
	Currency string `json:"currency"`
	// Recaptcha token for verification of customer
...
// GetRecaptchaToken returns the RecaptchaToken field value
...
// GetRecaptchaTokenOk returns a tuple with the RecaptchaToken field value
// and a boolean to check if the value has been set.
...
// SetRecaptchaToken sets field value
