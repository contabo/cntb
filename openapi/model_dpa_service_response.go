...
// DpaServiceResponse struct for DpaServiceResponse
type DpaServiceResponse struct {
	...
	// Optional Ip address of the service
...
func (o DpaServiceResponse) MarshalJSON() ([]byte, error) {
...
type NullableDpaServiceResponse struct {
	value *DpaServiceResponse
	isSet bool
}

func (v NullableDpaServiceResponse) Get() *DpaServiceResponse {
	return v.value
}

func (v *NullableDpaServiceResponse) Set(val *DpaServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDpaServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDpaServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpaServiceResponse(val *DpaServiceResponse) *NullableDpaServiceResponse {
	return &NullableDpaServiceResponse{value: val, isSet: true}
}

func (v NullableDpaServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpaServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
