...
// DomainTldsResponse struct for DomainTldsResponse
type DomainTldsResponse struct {
	...
	Tld string `json:"tld"`
	// Period of ownership of the domain in months
	Period int64 `json:"period"`
	// Month price to keep the domain
	Prices PricingModel `json:"prices"`
}
...
func (o DomainTldsResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainTldsResponse struct {
	value *DomainTldsResponse
	isSet bool
}

func (v NullableDomainTldsResponse) Get() *DomainTldsResponse {
	return v.value
}

func (v *NullableDomainTldsResponse) Set(val *DomainTldsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainTldsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainTldsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainTldsResponse(val *DomainTldsResponse) *NullableDomainTldsResponse {
	return &NullableDomainTldsResponse{value: val, isSet: true}
}

func (v NullableDomainTldsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainTldsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
