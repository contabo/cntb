...
// AvailablePaymentMethodResponse struct for AvailablePaymentMethodResponse
type AvailablePaymentMethodResponse struct {
	...
	// Payment method id
	PaymentMethodId float32 `json:"paymentMethodId"`
	// Payment method name
...
func NewAvailablePaymentMethodResponse(tenantId string, customerId string, paymentMethodId float32, paymentMethod string, directDebit bool) *AvailablePaymentMethodResponse {
	this := AvailablePaymentMethodResponse{}
...
func (o AvailablePaymentMethodResponse) MarshalJSON() ([]byte, error) {
...
type NullableAvailablePaymentMethodResponse struct {
	value *AvailablePaymentMethodResponse
	isSet bool
}

func (v NullableAvailablePaymentMethodResponse) Get() *AvailablePaymentMethodResponse {
	return v.value
}

func (v *NullableAvailablePaymentMethodResponse) Set(val *AvailablePaymentMethodResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAvailablePaymentMethodResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAvailablePaymentMethodResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAvailablePaymentMethodResponse(val *AvailablePaymentMethodResponse) *NullableAvailablePaymentMethodResponse {
	return &NullableAvailablePaymentMethodResponse{value: val, isSet: true}
}

func (v NullableAvailablePaymentMethodResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAvailablePaymentMethodResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
