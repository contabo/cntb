...
// PaymentMethodResponse1 struct for PaymentMethodResponse1
type PaymentMethodResponse1 struct {
...
func (o PaymentMethodResponse1) MarshalJSON() ([]byte, error) {
...
type NullablePaymentMethodResponse1 struct {
	value *PaymentMethodResponse1
	isSet bool
}

func (v NullablePaymentMethodResponse1) Get() *PaymentMethodResponse1 {
	return v.value
}

func (v *NullablePaymentMethodResponse1) Set(val *PaymentMethodResponse1) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodResponse1) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodResponse1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodResponse1(val *PaymentMethodResponse1) *NullablePaymentMethodResponse1 {
	return &NullablePaymentMethodResponse1{value: val, isSet: true}
}

func (v NullablePaymentMethodResponse1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodResponse1) UnmarshalJSON(src []byte) error {
	v.isSet = true
