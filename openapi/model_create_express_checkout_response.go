...
// CreateExpressCheckoutResponse struct for CreateExpressCheckoutResponse
type CreateExpressCheckoutResponse struct {
	Data []CreateExpressCheckoutResponseData `json:"data"`
...
func NewCreateExpressCheckoutResponse(data []CreateExpressCheckoutResponseData, links SelfLinks) *CreateExpressCheckoutResponse {
	this := CreateExpressCheckoutResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *CreateExpressCheckoutResponse) GetData() []CreateExpressCheckoutResponseData {
	if o == nil {
		var ret []CreateExpressCheckoutResponseData
		return ret
	}
...
func (o CreateExpressCheckoutResponse) MarshalJSON() ([]byte, error) {
...
type NullableCreateExpressCheckoutResponse struct {
	value *CreateExpressCheckoutResponse
	isSet bool
}

func (v NullableCreateExpressCheckoutResponse) Get() *CreateExpressCheckoutResponse {
	return v.value
}

func (v *NullableCreateExpressCheckoutResponse) Set(val *CreateExpressCheckoutResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateExpressCheckoutResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateExpressCheckoutResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateExpressCheckoutResponse(val *CreateExpressCheckoutResponse) *NullableCreateExpressCheckoutResponse {
	return &NullableCreateExpressCheckoutResponse{value: val, isSet: true}
}

func (v NullableCreateExpressCheckoutResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateExpressCheckoutResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
