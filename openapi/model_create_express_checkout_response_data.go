...
// CreateExpressCheckoutResponseData struct for CreateExpressCheckoutResponseData
type CreateExpressCheckoutResponseData struct {
...
func NewCreateExpressCheckoutResponseData(tenantId string, customerId string, token string) *CreateExpressCheckoutResponseData {
	this := CreateExpressCheckoutResponseData{}
...
func (o CreateExpressCheckoutResponseData) MarshalJSON() ([]byte, error) {
...
type NullableCreateExpressCheckoutResponseData struct {
	value *CreateExpressCheckoutResponseData
	isSet bool
}

func (v NullableCreateExpressCheckoutResponseData) Get() *CreateExpressCheckoutResponseData {
	return v.value
}

func (v *NullableCreateExpressCheckoutResponseData) Set(val *CreateExpressCheckoutResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateExpressCheckoutResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateExpressCheckoutResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateExpressCheckoutResponseData(val *CreateExpressCheckoutResponseData) *NullableCreateExpressCheckoutResponseData {
	return &NullableCreateExpressCheckoutResponseData{value: val, isSet: true}
}

func (v NullableCreateExpressCheckoutResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateExpressCheckoutResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
