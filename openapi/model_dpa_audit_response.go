...
// DpaAuditResponse struct for DpaAuditResponse
type DpaAuditResponse struct {
...
func (o DpaAuditResponse) MarshalJSON() ([]byte, error) {
...
type NullableDpaAuditResponse struct {
	value *DpaAuditResponse
	isSet bool
}

func (v NullableDpaAuditResponse) Get() *DpaAuditResponse {
	return v.value
}

func (v *NullableDpaAuditResponse) Set(val *DpaAuditResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDpaAuditResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDpaAuditResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDpaAuditResponse(val *DpaAuditResponse) *NullableDpaAuditResponse {
	return &NullableDpaAuditResponse{value: val, isSet: true}
}

func (v NullableDpaAuditResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDpaAuditResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
