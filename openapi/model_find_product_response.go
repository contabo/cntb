...
// FindProductResponse struct for FindProductResponse
...
func (o FindProductResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindProductResponse struct {
	value *FindProductResponse
	isSet bool
}

func (v NullableFindProductResponse) Get() *FindProductResponse {
	return v.value
}

func (v *NullableFindProductResponse) Set(val *FindProductResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindProductResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindProductResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindProductResponse(val *FindProductResponse) *NullableFindProductResponse {
	return &NullableFindProductResponse{value: val, isSet: true}
}

func (v NullableFindProductResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindProductResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
