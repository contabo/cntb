...
// DeleteDnsZoneRecordRequest struct for DeleteDnsZoneRecordRequest
type DeleteDnsZoneRecordRequest struct {
...
func NewDeleteDnsZoneRecordRequest(type_ string, ttl float32, prio float32, data string) *DeleteDnsZoneRecordRequest {
	this := DeleteDnsZoneRecordRequest{}
	this.Type = type_
	this.Ttl = ttl
	this.Prio = prio
	this.Data = data
...
func (o DeleteDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
...
type NullableDeleteDnsZoneRecordRequest struct {
	value *DeleteDnsZoneRecordRequest
	isSet bool
}

func (v NullableDeleteDnsZoneRecordRequest) Get() *DeleteDnsZoneRecordRequest {
	return v.value
}

func (v *NullableDeleteDnsZoneRecordRequest) Set(val *DeleteDnsZoneRecordRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteDnsZoneRecordRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteDnsZoneRecordRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteDnsZoneRecordRequest(val *DeleteDnsZoneRecordRequest) *NullableDeleteDnsZoneRecordRequest {
	return &NullableDeleteDnsZoneRecordRequest{value: val, isSet: true}
}

func (v NullableDeleteDnsZoneRecordRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteDnsZoneRecordRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
