...
func (r ApiCreateTicketRequest) XRequestId(xRequestId string) ApiCreateTicketRequest {
	r.xRequestId = &xRequestId
	return r
}
func (r ApiCreateTicketRequest) CreateTicketRequest(createTicketRequest CreateTicketRequest) ApiCreateTicketRequest {
	r.createTicketRequest = &createTicketRequest
	return r
}
// Identifier to trace group of requests.
func (r ApiCreateTicketRequest) XTraceId(xTraceId string) ApiCreateTicketRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiCreateTicketRequest) Execute() (CreateTicketResponse, *_nethttp.Response, error) {
...
*/
func (a *InternalApiService) CreateTicket(ctx _context.Context) ApiCreateTicketRequest {
	return ApiCreateTicketRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *InternalApiService) CreateTicketExecute(r ApiCreateTicketRequest) (CreateTicketResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InternalApiService.CreateTicket")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/create-ticket"
...
*/
func (a *InternalApiService) RetrieveUserIsPasswordSet(ctx _context.Context) ApiRetrieveUserIsPasswordSetRequest {
	return ApiRetrieveUserIsPasswordSetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *InternalApiService) RetrieveUserIsPasswordSetExecute(r ApiRetrieveUserIsPasswordSetRequest) (FindUserIsPasswordSetResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InternalApiService.RetrieveUserIsPasswordSet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
