...
// AddonIdentifierResponse struct for AddonIdentifierResponse
type AddonIdentifierResponse struct {
...
func (o AddonIdentifierResponse) MarshalJSON() ([]byte, error) {
...
type NullableAddonIdentifierResponse struct {
	value *AddonIdentifierResponse
	isSet bool
}

func (v NullableAddonIdentifierResponse) Get() *AddonIdentifierResponse {
	return v.value
}

func (v *NullableAddonIdentifierResponse) Set(val *AddonIdentifierResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAddonIdentifierResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAddonIdentifierResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddonIdentifierResponse(val *AddonIdentifierResponse) *NullableAddonIdentifierResponse {
	return &NullableAddonIdentifierResponse{value: val, isSet: true}
}

func (v NullableAddonIdentifierResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddonIdentifierResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
