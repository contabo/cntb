...
// GroupItemResponse struct for GroupItemResponse
...
func (o GroupItemResponse) MarshalJSON() ([]byte, error) {
...
type NullableGroupItemResponse struct {
	value *GroupItemResponse
	isSet bool
}

func (v NullableGroupItemResponse) Get() *GroupItemResponse {
	return v.value
}

func (v *NullableGroupItemResponse) Set(val *GroupItemResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupItemResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupItemResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupItemResponse(val *GroupItemResponse) *NullableGroupItemResponse {
	return &NullableGroupItemResponse{value: val, isSet: true}
}

func (v NullableGroupItemResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupItemResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
